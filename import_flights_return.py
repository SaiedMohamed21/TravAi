...
with open(r"C:\Users\saied mohamed\Desktop\data\Return_flights.csv", encoding="utf-8-sig") as f:
    ...
    for row in reader:
        ...
        # Flight (added AvailableSeats = 100)
...
with open("import_flights_return.sql", "w", encoding="utf-8") as f:
    f.write("\n".join(sql_statements))

print(f"Generated complete return flights SQL script.")
