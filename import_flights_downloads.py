...
with open(r"D:\Downloads\flights.csv", encoding="utf-8-sig") as f:
...
with open("import_flights_downloads.sql", "w", encoding="utf-8") as f:
    f.write("\n".join(sql_statements))

print(f"Generated complete flights SQL script from Downloads.")
