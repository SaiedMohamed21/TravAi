-- Seed Script for TEST_TOUR_EMERGENCY_V2_20271231
...
DECLARE @Marker NVARCHAR(100) = 'TEST_TOUR_EMERGENCY_V2_20271231';
...
VALUES (@UserId, @Tour1Id, @GuideId, 1, 100.00, 'USD', 'PendingUserDecision', 'Completed', @Now, CAST(@TourDate AS DATE), CAST(@TourDate AS TIME), @Marker + '_ORIGINAL_REFUND_WALLET', @Now);
...
INSERT INTO tourguide_TourBookings (UserId, TourId, TourGuideId, ParticipantsCount, TotalPrice, Currency, Status, PaymentStatus, BookingDate, TourDate, TourTime, SpecialRequests, CreatedAt)
VALUES (@UserId, @Tour2Id, @GuideId, 1, 100.00, 'USD', 'PendingUserDecision', 'Completed', @Now, CAST(@TourDate AS DATE), CAST(@TourDate AS TIME), @Marker + '_ORIGINAL_REFUND_STRIPE', @Now);
...
INSERT INTO tourguide_TourBookings (UserId, TourId, TourGuideId, ParticipantsCount, TotalPrice, Currency, Status, PaymentStatus, BookingDate, TourDate, TourTime, SpecialRequests, CreatedAt)
VALUES (@UserId, @Tour3Id, @GuideId, 1, 100.00, 'USD', 'PendingUserDecision', 'Completed', @Now, CAST(@TourDate AS DATE), CAST(@TourDate AS TIME), @Marker + '_ORIGINAL_ALTERNATIVE', @Now);
...
COMMIT;
PRINT 'Seed successful for TEST_TOUR_EMERGENCY_V2_20271231';
